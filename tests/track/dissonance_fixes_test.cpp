...
class MotifCounterChordAwareTest : public ::testing::Test {
 protected:
  void SetUp() override {
    ...
    vocal_track_.addNote(
        NoteEventBuilder::create(TICKS_PER_BAR, TICK_HALF, 67, 100));  // Bar 2 (G chord)
    vocal_track_.addNote(
        NoteEventBuilder::create(2 * TICKS_PER_BAR, TICK_HALF, 69, 100));  // Bar 3 (Am chord)
    vocal_track_.addNote(
        NoteEventBuilder::create(3 * TICKS_PER_BAR, TICK_HALF, 65, 100));  // Bar 4 (F chord)
