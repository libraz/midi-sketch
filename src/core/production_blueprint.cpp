...
constexpr TrackMask RHYTHMLOCK_DENSE_SYNTH_BED =
    TrackMask::Vocal | TrackMask::Chord | TrackMask::Bass | TrackMask::Motif | TrackMask::Arpeggio |
    TrackMask::Aux | TrackMask::Drums | TrackMask::Guitar | TrackMask::SE;
...
constexpr SectionSlot RHYTHMLOCK_FLOW[] = {
    ...
    {SectionType::Intro, 4, TrackMask::All, EntryPattern::Stagger, SectionEnergy::Low, 60, 50,
     PeakLevel::None, DrumRole::Ambient, -1.0f, SectionModifier::None, 100, ExitPattern::None,
     TimeFeel::OnBeat, 1.0f, ChorusDropStyle::None},

    // A melody: full rhythm bed, PedalTone guitar, Ostinato motif, voice limit=2, guide tone 50%
    {SectionType::A,
     8,
     RHYTHMLOCK_DENSE_SYNTH_BED,
     ...
     DrumRole::Full,
     -1.0f,
     SectionModifier::None,
     100,
     ExitPattern::None,
     TimeFeel::Pushed,
     1.0f,
     ChorusDropStyle::None,
     0,
     false,
     TrackMask::None,
     TrackMask::None,
    ...
    // B melody: full rhythm bed, PedalTone, voice limit=3, guide tone 60%, phrase tail rest
    {SectionType::B,
     8,
     RHYTHMLOCK_DENSE_SYNTH_BED,
    ...
    // Chorus: dense synth rhythm bed, voice limit=3, guide tone 55%
    {SectionType::Chorus,
     8,
     RHYTHMLOCK_DENSE_SYNTH_BED,
     EntryPattern::DropIn,
    ...
    // Interlude: keep a low motif bed under drums so the form breathes without
    // becoming a full-arrangement hole.
    {SectionType::Interlude, 4,
     TrackMask::Drums | TrackMask::Bass | TrackMask::Chord | TrackMask::Motif,
     EntryPattern::Immediate, SectionEnergy::Low, 65, 60, PeakLevel::None, DrumRole::Ambient, -1.0f,
     SectionModifier::None, 100, ExitPattern::None, TimeFeel::OnBeat, 1.0f, ChorusDropStyle::None},

    // 2nd A melody: full rhythm bed, PedalTone, Ostinato, voice limit=2, guide tone 50%
    {SectionType::A,
     8,
     RHYTHMLOCK_DENSE_SYNTH_BED,
     EntryPattern::Immediate,
    ...
    // 2nd B melody: full rhythm bed, PedalTone, voice limit=3, guide tone 60%, phrase tail rest
    {SectionType::B,
     8,
     RHYTHMLOCK_DENSE_SYNTH_BED,
     EntryPattern::GradualBuild,
    ...
    // 2nd Chorus: dense synth rhythm bed, voice limit=3, guide tone 55%
    {SectionType::Chorus,
     8,
     RHYTHMLOCK_DENSE_SYNTH_BED,
     EntryPattern::DropIn,
    ...
    // Drop chorus: vocal-forward breakdown with a light rhythm floor.
    {SectionType::Chorus, 4,
     TrackMask::Vocal | TrackMask::Drums | TrackMask::Bass | TrackMask::Motif,
     EntryPattern::Immediate, SectionEnergy::High, 85, 70, PeakLevel::None, DrumRole::Full, -1.0f,
     SectionModifier::None, 100, ExitPattern::CutOff, TimeFeel::OnBeat, 1.0f,
     ChorusDropStyle::DrumHit},

    // Last chorus: dense synth rhythm bed, voice limit=4 (relaxed), guide tone 55%
    {SectionType::Chorus,
     8,
     RHYTHMLOCK_DENSE_SYNTH_BED,
     EntryPattern::DropIn,
     ...
     DrumRole::Full,
     -1.0f,
     SectionModifier::Climactic,
     100,
     ExitPattern::FinalHit,
     TimeFeel::Pushed,
     0.5f,
     ChorusDropStyle::None,
     0,
    ...
    {SectionType::Outro, 4, TrackMask::Drums | TrackMask::Bass, EntryPattern::Immediate,
     SectionEnergy::Low, 60, 50, PeakLevel::None, DrumRole::Ambient, -1.0f, SectionModifier::None,
     100, ExitPattern::Fadeout, TimeFeel::OnBeat, 2.0f, ChorusDropStyle::None},
};
...
constexpr SectionSlot STORYPOP_FLOW[] = {
    ...
    {SectionType::Intro, 4, TrackMask::All, EntryPattern::Immediate, SectionEnergy::Medium, 70, 80,
     PeakLevel::None, DrumRole::Full, -1.0f, SectionModifier::None, 100, ExitPattern::None,
     TimeFeel::OnBeat, 1.0f, ChorusDropStyle::None},
    ...
    {SectionType::Outro, 4, TrackMask::All, EntryPattern::Immediate, SectionEnergy::Low, 65, 70,
     PeakLevel::None, DrumRole::Full, -1.0f, SectionModifier::None, 100, ExitPattern::Fadeout,
     TimeFeel::LaidBack, 2.0f, ChorusDropStyle::None},
};
...
constexpr SectionSlot BALLAD_FLOW[] = {
    ...
    {SectionType::Intro, 4, TrackMask::Chord, EntryPattern::Immediate, SectionEnergy::Low, 60, 60,
     PeakLevel::None, DrumRole::Full, 0.15f, SectionModifier::None, 100, ExitPattern::None,
     TimeFeel::LaidBack, 2.0f, ChorusDropStyle::None},
    ...
    {SectionType::Interlude, 4, TrackMask::Chord, EntryPattern::Immediate, SectionEnergy::Low, 60,
     55, PeakLevel::None, DrumRole::Full, 0.15f, SectionModifier::None, 100, ExitPattern::None,
     TimeFeel::LaidBack, 2.0f, ChorusDropStyle::None},
    ...
    {SectionType::Outro, 8, TrackMask::Chord, EntryPattern::Immediate, SectionEnergy::Low, 55, 50,
     PeakLevel::None, DrumRole::Full, 0.1f, SectionModifier::None, 100, ExitPattern::Fadeout,
     TimeFeel::LaidBack, 2.0f, ChorusDropStyle::None},
};
...
constexpr SectionSlot IDOL_STANDARD_FLOW[] = {
    ...
    {SectionType::Intro, 4, TrackMask::Drums, EntryPattern::Immediate, SectionEnergy::Low, 60, 50,
     PeakLevel::None, DrumRole::Minimal, -1.0f, SectionModifier::None, 100, ExitPattern::None,
     TimeFeel::OnBeat, 1.0f, ChorusDropStyle::None},
    ...
    {SectionType::Outro, 4, TrackMask::Drums | TrackMask::Chord, EntryPattern::Immediate,
     SectionEnergy::Low, 60, 50, PeakLevel::None, DrumRole::Ambient, -1.0f, SectionModifier::None,
     100, ExitPattern::Fadeout, TimeFeel::LaidBack, 2.0f, ChorusDropStyle::None},
};
...
constexpr SectionSlot IDOL_HYPER_FLOW[] = {
    ...
    {SectionType::MixBreak, 4, TrackMask::Vocal | TrackMask::Drums, EntryPattern::Immediate,
     SectionEnergy::High, 80, 70, PeakLevel::None, DrumRole::Ambient, 0.3f, SectionModifier::None,
     100, ExitPattern::CutOff, TimeFeel::OnBeat, 1.0f, ChorusDropStyle::DrumHit},
...
constexpr SectionSlot IDOL_COOLPOP_FLOW[] = {
    ...
    {SectionType::Interlude, 8, TrackMask::Drums | TrackMask::Bass | TrackMask::Arpeggio,
     ...
     SectionModifier::None, 100, ExitPattern::CutOff, TimeFeel::Pushed, 0.5f,
     ChorusDropStyle::DrumHit},
...
constexpr SectionSlot IDOL_EMO_FLOW[] = {
    ...
    // Quiet A (Ochisabi): Fingerpick, voice limit=2, guide tone 70%, vocal range 12st, phrase tail
    // rest
    {SectionType::A,
     4,
     TrackMask::Vocal | TrackMask::Chord,
    ...
    {SectionType::Outro, 4, TrackMask::Chord | TrackMask::Vocal, EntryPattern::Immediate,
     SectionEnergy::Low, 55, 50, PeakLevel::None, DrumRole::Ambient, -1.0f, SectionModifier::None,
     100, ExitPattern::Fadeout, TimeFeel::LaidBack, 2.0f, ChorusDropStyle::None},
};
