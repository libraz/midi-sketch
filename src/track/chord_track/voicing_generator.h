...
#ifndef MIDISKETCH_TRACK_CHORD_TRACK_VOICING_GENERATOR_H
#define MIDISKETCH_TRACK_CHORD_TRACK_VOICING_GENERATOR_H
...
/// @param root Root note (MIDI pitch)
/// @param chord Chord structure with intervals
/// @param bass_root_pc Bass note pitch class (0-11), or -1 if unknown
...
#endif  // MIDISKETCH_TRACK_CHORD_TRACK_VOICING_GENERATOR_H
