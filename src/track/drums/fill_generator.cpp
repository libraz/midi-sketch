...
FillType selectFillType(SectionType from, SectionType to, DrumStyle style,
  ...
  if (next_energy == SectionEnergy::Low) {
    ...
    switch (rng_util::rollRange(rng, 0, 2)) {
      ...
      case 1:
        return FillType::BreakdownFill;
      default:
        return FillType::HalfTimeFill;
    }
  }
  ...
  if (next_energy == SectionEnergy::Peak) {
    ...
    switch (rng_util::rollRange(rng, 0, 3)) {
      ...
      case 2:
        return FillType::LinearFill;
      default:
        return FillType::FlamsAndDrags;
    }
  }
    ...
    if (high_energy) {
      switch (choice) {
        ...
        case 3:
          return FillType::LinearFill;
        case 4:
          return FillType::BDSnareAlternate;
        case 5:
          return FillType::FlamsAndDrags;
        case 6:
          return FillType::TomShuffle;
        default:
          return FillType::GhostToAccent;
      }
    }
    switch (choice) {
      case 0:
