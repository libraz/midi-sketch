...
PitchChoice applyDirectionInertiaImpl(PitchChoice choice, int inertia, const MelodyTemplate& tmpl,
                                      std::mt19937& rng);
...
bool isInSameVowelSectionImpl(float pos1, float pos2, uint8_t phrase_length);
...
int8_t getMaxStepInVowelSectionImpl(bool in_same_vowel);
